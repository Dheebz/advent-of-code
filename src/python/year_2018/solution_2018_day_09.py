"""Marble Mania -- Advent of Code 2018 Day 9."""
...
def solve_part_one(config: Tuple[int, int]) -> int:
    """High score with given last marble."""
    players, last = config
    return play(players, last)


def solve_part_two(config: Tuple[int, int]) -> int:
    """High score with last marble 100x larger."""
    players, last = config
