...
def run_script(program: List[int], script: List[str]) -> int:
    """Execute the springdroid script and return the hull damage.

    Args:
        program (List[int]): Intcode program.
        script (List[str]): Springdroid instructions.

    Returns:
        int: Reported hull damage value.
    """
...
def solve_part_one(program: List[int]) -> int:
    """Use the walking script to clear the gap."""
    script = [
        "NOT A J",
        "NOT B T",
        "OR T J",
...
def solve_part_two(program: List[int]) -> int:
    """Use the running script with extended sensors."""
    script = [
        "NOT A J",
        "NOT B T",
        "OR T J",
        ...
        "OR T J",
        "AND D J",
        # ensure a safe landing spot or ability to keep moving
        "NOT E T",
        "NOT T T",
        "OR H T",
        "AND T J",
